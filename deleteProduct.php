...
<html lang="en">
    ...
    <body>
        ...
        <p>To search for a product's record to delete, please enter a search query below.</p>
        <form action="search_results/delete_product_search_results.php" method="GET">
